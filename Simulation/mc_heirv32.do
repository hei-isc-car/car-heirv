...
add wave -noupdate -expand -group Instr/Data -color Gold -label ramContent /heirv32_mc_tb/U_heirv32/U_instrDataMemory/U_bram/ramContent
add wave -noupdate -expand -group Instr/Data -label addressIn /heirv32_mc_tb/U_heirv32/U_instrDataMemory/U_bram/addressIn
add wave -noupdate -expand -group Instr/Data -color Green -label readData /heirv32_mc_tb/U_heirv32/U_instrDataMemory/readData
add wave -noupdate -expand -group Instr/Data -color Green -label instruction /heirv32_mc_tb/U_heirv32/U_instrForward/instruction
